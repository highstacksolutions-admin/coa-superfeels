...
<p>Our testing is carried out by <strong>Cora Science, LLC</strong> of Austin, Texas, a laboratory accredited to ISO/IEC 17025:2017 by PJLA. The lab, its address and its accreditation number are printed on every page of the report.</p>

<h2>Finding your lot number</h2>
<p>Every bottle carries a lot number printed on the label. It is short, a few letters followed by a few digits. That number, and only that number, ties the bottle in your hand to its lab reports.</p>
...
<p>The two are usually submitted weeks apart, so their dates will not agree, and neither will their Job IDs. That is normal and does not mean the reports disagree. What must match across them is the lot number. If the lookup page lists more than one report for your lot, read both.</p>
...
<li><strong>Name</strong> &mdash; the product the lab was given. It should describe what you bought.</li>
...
<ul>
<li><strong>Mitragynine</strong> &mdash; the most abundant alkaloid in the leaf, and the figure most people are looking for.</li>
<li><strong>7-Hydroxymitragynine</strong> &mdash; present naturally, in far smaller amounts than mitragynine.</li>
...
<li><strong>Total Mitragyna Alkaloids</strong> &mdash; the sum of the rows above.</li>
</ul>
<p>The relationship worth understanding is between the first two. In ordinary leaf material, 7-hydroxymitragynine sits well under one percent of the mitragynine figure. Work it out for yourself by dividing the one by the other. A report where 7-hydroxymitragynine makes up a large share of the total alkaloids is describing a concentrated or enriched product rather than a leaf one. The ratio tells you more than either number on its own.</p>
...
<li><strong>Flavokawain A, B and C</strong> &mdash; minor compounds reported for completeness. Any of them may come back below the limit of quantitation.</li>
<li><strong>Total Kavalactones</strong> &mdash; the figure to read if you want a single number.</li>
</ul>

<h3>Unit weight analysis</h3>
<p>A density measurement, in grams per millilitre. It looks like housekeeping, but the lab uses it to convert the potency results between units, which is the subject of the next section.</p>
...
<p>To get the amount in a whole unit, multiply the mg/mL figure by the volume of the bottle in millilitres, which is printed on your own label. A result of 1 mg/mL in a 50 mL bottle means 50 mg in the bottle. That arithmetic is the only way to turn a concentration into a per-bottle amount, and it is worth doing before comparing one product against another.</p>
...
<li><strong>Method Code</strong> &mdash; the laboratory reference for the procedure used. Beside it is the date and time the instrument ran.</li>
</ul>
